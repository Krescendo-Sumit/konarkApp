...
public class ThirdPartyAdapter extends RecyclerView.Adapter<ThirdPartyAdapter.DataObjectHolder> {
    ...
    public interface EventListener {
        void  onThirdPartySelected(CustomerModel customerModel);
    }

    public ThirdPartyAdapter(ArrayList<CustomerModel> lst_Orderdata, Context context, EventListener eventListener) {
        ...
        try {
            ...
            holder.txt_customername.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                 ...
                 eventListener.onThirdPartySelected(dataModel);
