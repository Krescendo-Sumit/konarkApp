...
public class CustomerAdapter extends RecyclerView.Adapter<CustomerAdapter.DataObjectHolder> {
    ...
    public interface EventListener {
        void  onCustomerSelected(CustomerModel customerModel);
    }

    public CustomerAdapter(ArrayList<CustomerModel> lst_Orderdata, Context context,EventListener eventListener) {
        ...
        try {
            ...
            holder.txt_customername.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                 ...
                 eventListener.onCustomerSelected(dataModel);
