...
public class SalesPersonAdapter extends RecyclerView.Adapter<SalesPersonAdapter.DataObjectHolder> {
    ...
    ArrayList<EmployeeModel> lst_Orderdata = null;

    public interface EventListener {

        void onSalesPersonSelected(EmployeeModel dataModel);
    }

    public SalesPersonAdapter(ArrayList<EmployeeModel> lst_Orderdata, Context context, EventListener eventListener) {
    ...
    public void onBindViewHolder(final DataObjectHolder holder, final int position) {
        try {
            EmployeeModel dataModel = lst_Orderdata.get(position);
            ...
            holder.txt_customername.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                 ...
                 eventListener.onSalesPersonSelected(dataModel);
